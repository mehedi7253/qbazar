...
<div class="row">
    <div class="col-lg-12">
        <div class="card">
            ...
            <div class="card-body">
               <form action="{{ route('product-stock.update',$product_id) }}" method="POST">
                @csrf
                @method('PUT')
                   <div class="form-group col-md-6 float-left">
                       <label>Stock Number<sup class="text-danger">*</sup></label>
                       <input name="product_id" value="{{ $product_id }}" hidden>
                       <input type="number" name="stock_quantity" placeholder="Enter Stock Number" class="form-control" value="{{ $prodcutstock }}">
                   </div>
                   <div class="form-group col-md-6 float-left">
                    <label></label>
