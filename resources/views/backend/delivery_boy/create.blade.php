    ...
    <div class="col-lg-12">
        <div class="card">
            <div class="card-header">
                <h4 class="header-title">{{ _lang('Add Delivery Boy') }}</h4>
            </div>
            <div class="card-body">
                <form method="post" class="validate" autocomplete="off" action="{{ route('delivery_boys.store') }}"
                    ...
                    <div class="row">
                        <div class="col-md-8 col-sm-12">
							...
							<div class="form-group row">
                                ...
                                <div class="col-xl-9">
                                    <input type="text" class="form-control" name="address" required>{{ old('address') }}</textarea>
                                </div>
                            </div>
