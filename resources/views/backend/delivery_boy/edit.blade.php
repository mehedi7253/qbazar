    ...
    <div class="col-lg-12">
        <div class="card">
            <div class="card-header">
                <h4 class="header-title">{{ _lang('Update Delivery Boy') }}</h4>
            </div>
            <div class="card-body">
                <form method="post" class="validate" autocomplete="off"
                    action="{{ action('DeliveryBoyController@update', $id) }}" enctype="multipart/form-data">
                    {{ csrf_field()}}
                        ...
                        <div class="col-md-8">
                            ...
                            <div class="form-group row">
                                <div class="col-xl-9 offset-xl-3">
                                    <button type="submit" class="btn btn-primary btn-lg"><i class="icofont-check-circled"></i>{{ _lang('Update User') }}</button>
                                </div>
                            </div>
                        </div>
                    </div>
