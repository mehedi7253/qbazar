    ...
    <div class="col-lg-12">
        ...
        <div class="card no-export">
            ...
            <div class="card-header">
                ...
                <h6>Total Products: From {{ $from }} To {{ $to }}
                </h6>
                @elseif($from == NULL && $to == NULL)
                <h6>Please Select Date First!
                </h6>
                @elseif($from !== NULL)
                <h6>Total Products: In {{ $from }}
                </h6>
                @elseif($to !== NULL)
                <h6>Total Products: In {{ $to }}
                </h6>
                @endif
            ...
            <div id="abc">
                <form action="{{route('order.product.search.download')}}">
                    @csrf
